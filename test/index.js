...
describe('Babel Macros', function () {
  ...
  run("wrong-name", new Error("unknown: First argument to DEFINE_MACRO must be an identifier, at Line: 1 Column: 1"));
  run("wrong-function", new Error("unknown: Second argument to DEFINE_MACRO must be a FunctionExpression or ArrowFunctionExpression, at Line: 4 Column: 1"));
  run("this-in-macro", new Error("unknown: Can not use `this` in macro, at Line: 1 Column: 1"));
  run("arguments-in-macro", new Error("unknown: Can not use `arguments` in macro, at Line: 1 Column: 1"));
